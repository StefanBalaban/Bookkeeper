...
namespace Tulumba.Migrations
{
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "AppDailyEarnings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    Date = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    ShopId = table.Column<Guid>(type: "uuid", nullable: false),
                    EarningAmount = table.Column<decimal>(type: "numeric", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppDailyEarnings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppDailyEarnings_AppShops_ShopId",
                        column: x => x.ShopId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppMonthlyCashFlows", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppMonthlyCashFlows_AppShops_ShopId",
                        column: x => x.ShopId,
                        principalTable: "AppShops",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppDailyEarnings_ShopId",
                table: "AppDailyEarnings",
                column: "ShopId");

            migrationBuilder.CreateIndex(
                name: "IX_AppMonthlyCashFlows_ShopId",
