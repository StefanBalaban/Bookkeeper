...
{
    [DbContext(typeof(TulumbaDbContext))]
    [Migration("20220413185051_Created_RecurringExpense_Entity")]
    partial class Created_RecurringExpense_Entity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tulumba.Entities.DailyCashFlow.DailyCashFlow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("MonthlyCashFlowId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MonthlyCashFlowId");

                    b.HasIndex("ShopId");

                    b.ToTable("AppDailyCashFlows");
                });

            modelBuilder.Entity("Tulumba.Entities.DailyEarning.DailyEarning", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("DailyCashFlowId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DailyCashFlowId");

                    b.HasIndex("ShopId");

                    b.ToTable("AppDailyEarnings");
                });

            modelBuilder.Entity("Tulumba.Entities.Employee.Employee", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tulumba.Entities.Expense.Expense", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tulumba.Entities.ExpenseType.ExpenseType", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tulumba.Entities.MonthlyCashFlow.MonthlyCashFlow", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppMonthlyCashFlows");
                });

            modelBuilder.Entity("Tulumba.Entities.RecurringExpense.RecurringExpense", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppRecurringExpenses");
                });

            modelBuilder.Entity("Tulumba.Entities.Shop.Shop", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Tulumba.Entities.DailyCashFlow.DailyCashFlow", b =>
                {
                    b.HasOne("Tulumba.Entities.MonthlyCashFlow.MonthlyCashFlow", "MonthlyCashFlow")
                        .WithMany()
                        .HasForeignKey("MonthlyCashFlowId");

                    b.HasOne("Tulumba.Entities.Shop.Shop", "Shop")
                        .WithMany()
                        .HasForeignKey("ShopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MonthlyCashFlow");
            ...
            modelBuilder.Entity("Tulumba.Entities.DailyEarning.DailyEarning", b =>
                {
                    b.HasOne("Tulumba.Entities.DailyCashFlow.DailyCashFlow", "DailyCashFlow")
                        .WithMany()
                        .HasForeignKey("DailyCashFlowId");
            ...
            modelBuilder.Entity("Tulumba.Entities.Expense.Expense", b =>
                {
                    ...
                    b.HasOne("Tulumba.Entities.Employee.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("Tulumba.Entities.ExpenseType.ExpenseType", "ExpenseType")
                        .WithMany()
